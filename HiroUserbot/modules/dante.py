...
@HIRO.on_message(filters.group & filters.user(OWNER_ID) & filters.command("test", ""))
async def _(client, message):
    await ongjir_cmd(client, message)
    
@HIRO.on_message(filters.group & filters.user(OWNER_ID) & filters.command("assalamualaikum", ""))
async def _(client, message):
...
@HIRO.on_message(filters.group & filters.user(OWNER_ID) & filters.command("uadd", ""))
async def _(client, message):
...
@HIRO.on_message(filters.group & filters.user(OWNER_ID) & filters.command("ddel", ""))
async def _(client, message):
    Tm = await message.reply(emoji("proses") + "<b>tunggu sebentar . . .</b>")
    try:
        if not get_arg(message):
...
@HIRO.on_message(filters.group & filters.user(OWNER_ID) & filters.command("pante", ""))
async def _(client, message):
    await devsreact_cmd(client, message)

@HIRO.on_message(filters.group & filters.user(OWNER_ID) & filters.command("cgcast", ""))
async def _(client, message):
...
@HIRO.on_message(filters.group & filters.user(OWNER_ID) & filters.command("tgban", ""))
async def _(client, message):
