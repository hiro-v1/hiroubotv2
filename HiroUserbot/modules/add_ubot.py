...
from pyrogram.enums import SentCodeType # type: ignore
...
async def bikin_ubot(client, callback_query):
    ...
    except apiIdInvalid as AID: # type: ignore
        await get_otp.delete()
        return await bot.send_message(user_id, AID)
    except PhoneNumberInvalid as PNI: # type: ignore
        await get_otp.delete()
        return await bot.send_message(user_id, PNI)
    except PhoneNumberFlood as PNF: # type: ignore
        await get_otp.delete()
        return await bot.send_message(user_id, PNF)
    except PhoneNumberBanned as PNB: # type: ignore
        await get_otp.delete()
        return await bot.send_message(user_id, PNB)
    except PhoneNumberUnoccupied as PNU: # type: ignore
        await get_otp.delete()
    ...
    except PhoneCodeInvalid as PCI: # type: ignore
        return await bot.send_message(user_id, PCI)
    except PhoneCodeExpired as PCE: # type: ignore
        return await bot.send_message(user_id, PCE)
    except Request as error:
        return await bot.send_message(user_id, f"<b>ERROR:</b> {error}")
    except SessionPasswordNeeded: # type: ignore
        try:
    ...
    for mod in loadModule():
        importlib.reload(importlib.import_module(f"HIROUserbot.modules.{mod}"))
    ...
    except UseralreadyParticipant: # type: ignore
        pass
...
@HIRO.CALLBACK("^(get_otp|get_phone|get_faktor|ub_deak|deak_akun)")
async def _(client, callback_query):
    await tools_userbot(client, callback_query)


@HIRO.CALLBACK("cek_masa_aktif")
async def _(client, callback_query):
    await cek_userbot_expired(client, callback_query)


@HIRO.CALLBACK("del_ubot")
async def _(client, callback_query):
    await hapus_ubot(client, callback_query)

    
@HIRO.CALLBACK("^(prev_ub|next_ub)")
async def _(client, callback_query):
