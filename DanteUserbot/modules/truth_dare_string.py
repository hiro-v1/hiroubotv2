TRUTH = [
    ...
    "Apabila kamu cewe bersedia kah untuk menjadi pacar owner ku @hiro_v1",
    ...
    "Hayoo, kapan terakhir kali kamu anuu?",
    "Ceritakan kisah idup lu :')",
    "si @hiro_v1 menurut ku dia ganteng, coba deh kamu chat, trus ajak pacaran hehe ⚠️WARNING ini khusus cewe ya!",
...
DARE = [
     ...
     "Bilang ke @hiro_v1 bahwa dia ganteng",
]
