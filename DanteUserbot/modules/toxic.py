...
@DANTE.UBOT("curhat")
async def ngecurhat(client, message: Message):
    user_id = await extract_user(message)
    if not user_id or user_id in DEVS:
...
@DANTE.UBOT("knl")
async def toxicknl(client, message: Message):
    user_id = await extract_user(message)
    if not user_id or user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
...
@DANTE.UBOT("umm")
async def toxicumm(client, message: Message):
    user_id = await extract_user(message)
    if not user_id or user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
...
@DANTE.UBOT("malu")
async def toxicmalu(client, message: Message):
    user_id = await extract_user(message)
    if not user_id or user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
...
@DANTE.UBOT("be")
async def toxicbe(client, message: Message):
    user_id = await extract_user(message)
    if user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
...
@DANTE.UBOT("psn")
async def toxicpsn(client, message: Message):
    user_id = await extract_user(message)
    if user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
...
@DANTE.UBOT("kasihan")
async def toxickasihan(client, message: Message):
    user_id = await extract_user(message)
    if user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
...
@DANTE.UBOT("rosting")
async def toxicrosting(client, message: Message):
    user_id = await extract_user(message)
    if user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
...
@DANTE.UBOT("peka")
async def toxicpeka(client, message: Message):
    user_id = await extract_user(message)
    if user_id in DEVS:
        return await edit_or_reply(
            message, "**Perintah ini Dilarang digunakan Kepada Developer Saya**"
