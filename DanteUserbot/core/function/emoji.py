def emoji(alias):
    emojis = {
        ...
        "berhasil": "<emoji id=6278555627639801385>✅</emoji>",  # Example emoji for BERHASIL
        "ping": "<emoji id=5801044672658805468>✨</emoji>",      # Example emoji for PING
        "mention": "<emoji id=5911461474315802019>⭐</emoji>",   # Example emoji for MENTION
        "ubot": "<emoji id=5911100572508885928>♻️</emoji>",     # Example emoji for UBOT
    }
